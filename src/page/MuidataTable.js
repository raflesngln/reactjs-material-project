...
import TableBody from "./../components/muidatatables/components/TableBody";
import TableFilterList from "./../components/muidatatables/components/TableFilterList";
import TableFooter from "./../components/muidatatables/components/TableFooter";
import TableHead from "./../components/muidatatables/components/TableHead";
import TableResize from "./../components/muidatatables/components/TableResize";
import TableToolbar from "./../components/muidatatables/components/TableToolbar";
import TableToolbarSelect from "./../components/muidatatables/components/TableToolbarSelect";
import getTextLabels from "./../components/muidatatables/textLabels";
import {
  buildMap,
  ...
  getPageValue,
  warnDeprecated
} from "./../components/muidatatables/utils";
...
class MUIDataTable extends React.Component {
  ...
  handleOptionDeprecation = () => {
    ...
    this.props.columns.map(c => {
      if (c.options && c.options.customFilterListOptions) {
        warnDeprecated(
